          ...
          <template slot="header">
            <div class="row">
              <div class="col-sm-6" :class="isRTL ? 'text-right' : 'text-left'">
                ...
                <h2 class="card-title">{{ this.bigLineChart.country }}</h2>
                <select
                  id="country"
                  name="country"
                  v-model="country"
                  @change="setData(country)"
                >
...
export default {
  ...
  methods: {
    ...
    async setData(country) {
      this.bigLineChart.country = country;
      let response = await covid_api.fetchCountryCases(country);

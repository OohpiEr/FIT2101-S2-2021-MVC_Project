...
// installed nodemon to avoid constantly restarting server, at terminal, use -> npm run start:server
// (This can be change at package.json->scripts and change the name)